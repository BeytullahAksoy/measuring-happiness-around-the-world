...
#copied from : https://github.com/StanislasBertrand/RetinaFace-tf2/blob/master/retinaface.py
...
# copied from: https://github.com/StanislasBertrand/RetinaFace-tf2/blob/master/rcnn/processing/bbox_transform.py
...
# based on : https://github.com/StanislasBertrand/RetinaFace-tf2/blob/master/rcnn/cython/anchors.pyx
